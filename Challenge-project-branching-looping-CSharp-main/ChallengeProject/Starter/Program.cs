...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            // Enter an age for ID #:
            // if hit enter repeat above prompt 
            // has to be a valid number or repeats the prompt
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                // can't be null or zero chars
                // or "Physical description: tbd"
                ...
                if ((ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd") && ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            if (animalPhysicalDescription == "") // empty string
                            {
                                validEntry = false;
                            }
                            else
                    ...
                    // if age and description valid, print 
        ...
        case "4":
            ...
            {
                // Nickname 
                if ((ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: tbd") && ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            if (animalNickname == "") // empty string
                            {
                                validEntry = false;
                            }
                            else
                ...
                if ((ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: tbd") && ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            if (animalPersonalityDescription == "") // empty string
                            {
                                validEntry = false;
                            }
                            else
